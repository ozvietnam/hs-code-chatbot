...
// ═══════════════════════════════════════════════════════
// WS-006: Extended TTL for compliance with Vietnamese customs law
// Requires audit trail retention for tariff decisions (7-14 days minimum)
// ═══════════════════════════════════════════════════════
const SESSION_TTL = parseInt(process.env.SESSION_TTL_DAYS || '7', 10) * 24 * 60 * 60; // 7d default (configurable)
const META_TTL = parseInt(process.env.META_TTL_DAYS || '7', 10) * 24 * 60 * 60; // 7d for metadata
const ARCHIVE_TTL = parseInt(process.env.ARCHIVE_TTL_DAYS || '30', 10) * 24 * 60 * 60; // 30d for cold storage
