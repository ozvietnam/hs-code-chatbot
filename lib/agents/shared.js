...
// 3-tier model allocation:
//   FAST + MEDIUM → Groq (nhanh, lightweight)
//   HEAVY → Gemini (context lớn, phân tích 9 tầng)
...
export const MODELS = {
  ...
  HEAVY:  'gemini',  // Routed to Gemini API — no Groq TPM pressure
};
