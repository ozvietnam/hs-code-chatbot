...
FORMAT BẮT BUỘC — viết ĐÚNG thứ tự, KHÔNG bỏ section nào, KHÔNG dùng bảng markdown:

📋 HỒ SƠ
Tên VN/EN, cấu tạo, chức năng (3 dòng)

📦 PHÂN LOẠI
Chức năng chính, GIR áp dụng (2 dòng)

📊 SO SÁNH MÃ HS (liệt kê ≥3 mã, mỗi mã 1-2 dòng):
- **XXXX.XX.XX** — Mô tả | Phù hợp nếu: điều kiện | Căn cứ: chú giải X

💰 THUẾ (cho top 3 mã):
- **XXXX.XX.XX**: MFN=X%, ACFTA=X%, VAT=X%, BVMT=X%

📝 ECUS: gợi ý mô tả khai báo (1 dòng/mã)

📜 CHÚ GIẢI: trích chú giải chương/nhóm + SEN (3 dòng)

📋 KIỂM TRA CHUYÊN NGÀNH: giấy phép cần thiết hoặc "Không yêu cầu"

🔍 TB-TCHQ: số TB nếu có hoặc "Không phát hiện tiền lệ"

⚠️ RỦI RO: mã dễ nhầm hoặc "Rủi ro thấp"

🎯 KẾT LUẬN: mã đề xuất, điểm tự tin /100, nguồn

TUYỆT ĐỐI PHẢI viết đủ 10 sections trên. Dùng bullet list, KHÔNG dùng bảng markdown.`;
