...
const FOLLOWUP_PATTERNS = {
  chu_giai: /ch[uú] gi[aả]i|sen|legal|annotation/i,
  tb_tchq: /tb[- ]?tchq|th[oô]ng b[aá]o|precedent|ti[eề]n l[eệ]/i,
  rui_ro: /r[uủ]i ro|d[eễ] nh[aầ]m|conflict|tranh ch[aấ]p/i,
  ecus: /ecus|m[oô] t[aả] khai|khai b[aá]o/i,
  kiem_tra: /ki[eể]m tra|chuy[eê]n ng[aà]nh|gi[aấ]y ph[eé]p|ki[eể]m d[iị]ch/i,
  cong_van: /c[oô]ng v[aă]n|gi[aả]i tr[iì]nh|[aá]p m[aã]/i,
  thue_fta: /thu[eế].*fta|so s[aá]nh thu[eế]|acfta|atiga|evfta|cptpp/i,
};
...
CÁCH TRẢ LỜI:
1. Dùng kiến thức chuyên gia, đề xuất 2-3 mã HS tiềm năng + điều kiện phù hợp
2. Hỏi 1-2 câu CỤ THỂ để phân loại chính xác (vật liệu? chức năng? kích thước?)
3. GỢI Ý follow-up: "Xem chú giải chi tiết", "TB-TCHQ liên quan"...

Trả lời tiếng Việt, ngắn gọn, chuyên nghiệp. KHÔNG dump thông tin thừa.`;
  }
